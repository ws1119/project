...
save_path = "model_saved/best_model_outputway-{}_batch-{}_lr-{}.pth"\
    .format(output_way, batch_size, lr)
...
sts_dev_file = 'cnsd-sts-valid.txt'
...
if __name__ == '__main__':
    ...
    with open("result/test_result.txt", "a", encoding="utf-8") as f:
        f.write(str(curren_time) + "\n" + "batch_size=" + str(batch_size) + "output_way=" + output_way +
